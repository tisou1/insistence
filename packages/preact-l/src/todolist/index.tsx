...
function InputValue(props: { onChange: (value: string) => void }) {
  ...
  return (
    <div className='flex gap-4 my-3 justify-between'>
      <input type='text' value={value} onChange={onChange} className="grow border-solid border-gray-400/50 rounded-12px h-42px outline-none focus:border-orange-500/30 text-18px text-gray-300"/>
